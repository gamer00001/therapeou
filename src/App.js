...
import { Typography, Card, CardHeader, Avatar, CardContent,  CardMedia} from '@mui/material';
...
function App() {
  ...
  <>
    ...
    <Container  maxWidth={false} sx={{backgroundColor: "#C8C8C8", marginTop: 5, paddingBottom: 5 }}>
      <Grid
          container
          direction="column"
      ...
      >
        <Grid item>
          <Typography variant="h5" component="h5" style={{color: "#3C5671"}}>
                Services
          </Typography>
        </Grid>
        <Grid item >
      ...
      <Grid  container direction="row" justifyContent="center" spacing={2}>
      {
          SERVICE_CONTENT.map((item) => (
            <Grid item>
            <Card sx={{ maxWidth: 270, borderRadius: "6px", minHeight: "240px" }}>
              <CardHeader
                avatar={
                  <Avatar  aria-label="recipe" variant="square" src={item.image} sx={{ bgcolor: "#DBE7FF"}} />
                }
              />
    ...
    <Container  maxWidth={false} sx={{backgroundColor: "#E8F1FB", marginTop: 5, paddingBottom: 5 }}>
      <Grid
        container
        direction="column"
        justifyContent="center"
      ...
      >
          <Grid item>
            <Typography variant="h5" component="h5" style={{color: "#204EA5"}}>
              Dr. Adaria Warner
            </Typography>
          </Grid>
          <Grid item >
    ...
    <Container  maxWidth={false} sx={{backgroundColor: "#C8C8C8", marginTop: 8, paddingBottom: 5 }}>
      <Grid
        container
        direction="row"
        style={{padding: 20}}
      ...
      >
          ...
          <Grid item md={6} style={{marginTop: 37}}>
            ...
            <Typography variant="h6" component="h6" color="#323232" style={{marginTop: 30}}>
              Their core mission is to provide compassionate, non-judgmental support to individuals who are struggling with mental health issues, relationship difficulties, and other life challenges.
            </Typography>
            <Typography variant="div" component="div" style={{marginTop: 64}}>
              <Button variant="contained" style={{background: "#3C5671", marginRight: 30}}> Book an Appointment </Button>
              <Button variant="outlined" style={{borderColor: "#3C5671",color: "#3C5671"}}>About Us</Button>
            </Typography>
        </Grid>
        </Grid>
    </Container>
    ...
    <Container  maxWidth={false} sx={{backgroundColor: "#C8C8C8", marginTop: 5, paddingBottom: 5 }}>
      ...
      <Grid  container direction="row" justifyContent="center" spacing={2}>
      {
          TESTIMONIAL.map((item, i) => (
            <Grid item>
            <Card sx={{ maxWidth: 370, borderRadius: "6px", minHeight: "160px" }}>
              <CardContent>
                <Typography variant="body2" color="text.secondary">
                  {item.content}
                </Typography>
